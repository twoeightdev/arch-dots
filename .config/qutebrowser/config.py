...
config.bind("<Alt-f>", "hint links spawn --detach mpv --profile=H60 --force-window yes {hint-url}")
config.bind("<Alt-Shift-f>", "hint links spawn --detach mpv --profile=H60 force-window yes {hint-url}")
